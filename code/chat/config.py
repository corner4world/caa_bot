...
dic_config["form_default"] = "script" #---表单默认提交
dic_config["numb_find"] = "8" #---热点搜索最大匹配关键词队列数
dic_config["numb_limit_hot"] = "10" #---热点搜索匹配候选数

# ---- 加密解密参数配置 ---
dic_config["secret_key"] = "8wetyrrr^$" #---默认密钥
dic_config["secret_salt"] = b'jdshgfonlsdgpeeerw09vos-%$&' #---默认密钥salt
...
# ---- 问答引擎参数配置 ---
dic_config["qa_index_similar_is"] = "0" #知识库问答匹配是否采用索引法
dic_config["qa_gossip_index_is"] = "0" #闲聊问答匹配是否采用索引法
dic_config["dialog_history_if"] = "1" #默认回写历史记录
dic_config["numb_chatlist"] = "10" # 调用的对话历史文件条数
dic_config["numb_limit_chat"] = "5000" # 子表的匹配候选数
dic_config["numb_ok_chat"] = "3" #---最终答案抽取数
dic_config["threshold_similar_chat"] = "0.599" #---问题对问题相似匹配阈值
dic_config["numb_avg_answer"] = "253" #---答案的平均长度
...
dic_config["test_if"] = "0" #---是否打开调试模式 0 否 1 是 2 特殊
dic_config["chat_clear_if"] = "1" #---是否进行语义清理
dic_config["path_chat_old"] = "./data/chatfile/" # 对话历史文件路径
