...
if __name__ == '__main__':
    ...
    df_matrix_train = pd.DataFrame(df_matrix_train,columns=['label']+high_word).fillna(0)
    ...
    df_matrix_test = pd.DataFrame(df_matrix_test,columns=['question','label']+high_word).fillna(0)
    
    train_X = df_matrix_train.drop(['label'], axis = 1)
